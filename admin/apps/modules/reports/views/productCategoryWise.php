                                        ...
                                        <table id="example" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="example_info">
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <td><?=currency($this->website->web_currency);?><?php echo $cplist->min_value;?></td>
                                                    <td><?=currency($this->website->web_currency);?><?php echo $cplist->pro_gst;?></td>
                                                    <td><?=currency($this->website->web_currency);?><?php $total = (($cplist->pro_price*$cplist->pro_qty)+$cplist->min_value+$cplist->pro_gst); echo number_format((float)$total, 2, '.', '');?></td>
