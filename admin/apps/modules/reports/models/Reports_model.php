...
class Reports_model extends MY_Model{
	...
	{
		$this->db->select('cat.cate_id,cat.cate_name,txt.txt_per,ord.ord_reference_no, ship.min_value, op.ord_id, op.pro_name, op.pro_selling_price, op.pro_special_price, op.pro_price, op.pro_gst, op.pro_coupon, op.pro_discount_per, op.pro_discount_value, op.pro_qty, op.ord_create');
