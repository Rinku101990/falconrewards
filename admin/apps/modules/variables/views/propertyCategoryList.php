                      ...
                      <table id="example" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="example_info">
                        <thead>
                          <tr role="row">
                            ...
                            <th class="wd-15p sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending">Category Name</th>
                            <th class="wd-15p sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending">Modified</th>
                        ...
                        <tbody>
                          <?php //print("<pre>".print_r($propertyCategoryList,true)."</pre>");?>
                          <?php if(!empty($propertyCategoryList)){ $i=1; foreach($propertyCategoryList AS $pclist){?>
                          <tr role="row">
                            <td class="sorting_1" align="center"><?=$i;$i++;?></td>
                            <td><?=$pclist->procat_name;?></td>
                            <td><?=date('j M Y G:i A',strtotime($pclist->procat_created));?></td>
                            <td>
                              <?php if($pclist->procat_status=='0'){ ?>
                            ...
                            <td>
                                <a href="<?php echo site_url('variables/edit/'.encode($pclist->procat_id));?>" class="btn btn-info btn-sm mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                                <a href="<?php echo site_url('variables/trash/'.encode($pclist->procat_id));?>" class="btn btn-danger btn-sm mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-trash"></i></a>
                            </td>
                          </tr>
                          <?php } } ?>
                        </tbody>
