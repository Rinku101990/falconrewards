      ...
      <div class="page-header">
         ...
         <div class="mt-3 mt-lg-0">
            <div class="d-flex align-items-center flex-wrap text-nowrap"> 
               ...
               <a href="<?=base_url('products/reward_add');?>">
                              ...
                              <table id="example" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="example_info">
                                 ...
                                 <tbody>
                                    ...
                                    <tr role="row" >
                                     ...
                                     <td align="center">
                                       <a href="javascript:void(0);"onclick="javascript:showMyModalSetTitle('Change Status','reward_status/',<?=$list->r_id;?>,<?php if($list->r_status=='0'){echo'1';}else{echo'0';}?>)">
                                    ...
                                    <td > <?=date('d M, Y h:i:s',strtotime($list->r_created));?></td>
                                       <td align="center"> 
                                          <a href="<?=base_url('products/reward-edit/').encode($list->r_id);?>" class="btn btn-info btn-sm mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                                        
                                          <a href="javascript:void(0);" onclick="javascript:showMyModalSetTitle('Delete','products/reward_delete/',<?=$list->r_id;?>,'')" class="btn btn-danger btn-sm mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-trash"></i></a>
                                       </td>
                                    </tr>
                                    <?php }}?>
                                 </tbody>
