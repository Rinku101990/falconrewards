    ...
    <?php }?>
                     <div class="row">
                        ...
                        <div class="col-sm-6 col-md-6">
                           ...
                           <input type="text" name="r_title" value="<?=$reward->r_title;?>" class="form-control">
                        </div>
                       
                        <div class="col-sm-6 col-md-6">
                           <label>URL <span class="red">*</span></label>
                           <input type="text" name="r_url" value="<?=$reward->r_url;?>"  class="form-control "  />
                       ...
                       <div class="col-sm-12 col-md-12" >
                        ...
                        <div class="col-sm-12 col-md-12" style="    margin-bottom: 19px;">
                           ...
                           <textarea rows="5" name="r_description" class="form-control " id="summernote" style="height:100px"><?=$reward->r_description;?></textarea>
