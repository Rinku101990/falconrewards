            ...
            <div class="card-body">
               <div class="account_login_form">
                  <div class="GeneralResponse"> </div>                  
                    <form id="RewardForm" action="<?=base_url('rewards/reward_save');?>" method="post" enctype="multipart/form-data" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6">
                               ...
                               <input type="text" name="r_title" class="form-control" placeholder="Enter Reward Title">
                            </div>
                           
                            <div class="col-sm-6 col-md-6">
                               <label>Title(Arabic) <span class="red">*</span></label>
                               <input type="text" name="r_title_ar"  class="form-control " placeholder="Enter Reward Arabic Title"/>
                            </div>
                            
                            <div class="col-sm-6 col-md-6">
                               <label>URL Text <span class="red">*</span></label>
                               <input type="text" name="r_url" class="form-control" placeholder="Enter Reward URL Text">
                            </div>
                           
                            <div class="col-sm-6 col-md-6">
                               <label>URL Text(Arabic) <span class="red">*</span></label>
                               <input type="text" name="r_url_ar"  class="form-control "  placeholder="Enter Reward Arabic URL Text"/>
                            </div>
                            
                            <div class="col-sm-6 col-md-6">
                               <label>Winning Price(English) <span class="red">*</span></label>
                               <input type="text" name="r_price" class="form-control" placeholder="Enter Winning Price Description"/>
                            </div>
                            <div class="col-sm-6 col-md-6">
                               <label>Winning Price(Arabic) <span class="red">*</span></label>
                               <input type="text" name="r_price_ar" class="form-control" placeholder="Enter  Winning Price Description in Arabic"/>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-6" >
                               ...
                               <textarea name="r_short_description" class="form-control"  style="height:100px" placeholder="Enter short Description"></textarea>
                            </div>
                            <div class="col-sm-6 col-md-6" >
                               <label>Short Decsription(Arabic) <span class="red">*</span></label>
                               <textarea name="r_short_description_ar" class="form-control"  style="height:100px" placeholder="Enter short Arabic Description"></textarea>
                            </div>
                        
                            <div class="col-sm-6 col-md-6" style="margin-bottom: 19px;">
                               <label> Decsription <span class="red"></span></label>
                               <textarea rows="5" name="r_description" class="form-control " id="summernote2" ></textarea>
                               <span id="LongDesc"></span>
                            </div>
                            
                            <div class="col-sm-6 col-md-6" style="margin-bottom: 19px;">
                               <label> Decsription(Arabic) <span class="red"></span></label>
                               <textarea rows="5" name="r_description_ar" class="form-control " id="summernote3" ></textarea>
