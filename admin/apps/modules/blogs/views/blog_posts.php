                                        ...
                                        <table id="example" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="example_info">
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <td align="center">
                                                        <a href="<?php echo site_url('blogs/edit/'.$blglist->blg_id);?>" class="btn btn-info btn-sm mt-2 mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="View"><i class="fa fa-eye"></i></a>
