...
<div class="section">
   ...
   <div class="page-header">
      <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item active" aria-current="page">Edit Winner</li>
      </ol>
      ...
      <div class="col-lg-10 col-xl-12 col-md-12 col-sm-12">
         <div class="card">
            <div class="card-header" style="padding-bottom: 0px;">
               <h3 class="card-title"><span>Edit Winner</span></h3>
            </div>
            <div class="card-body">
                  ...
                  <form action="" method="post" enctype="multipart/form-data" >
                    <input type="hidden" name="drw_id" value="<?=$draws->drw_id;?>">
                        ...
                        <div class="row">
                            ...
                            <!--    <select name="drw_category" class="form-control drw_category">-->
                            <!--      <option value="">select</option>-->
                            <!--      <//?php //if(!empty($category)){-->
                            <!--         //foreach ($category as $c_list) {?>-->
                            <!--            <option value="<//?php echo $cid=$c_list->procat_id;?>" <//?php if($draws->drw_category==$cid)echo'selected';?>><//?=$c_list->procat_name;?></option>-->
                            <!--         <//?php }-->
                            <!--         }-->
                            <!--         ?>-->
                            <!--   </select>-->
                            <!--   <span id="drw_category"></span>-->
                            <!--</div>-->
                            ...
                            <div class="col-sm-6 col-md-6">
                               <label>video File<span class="red">*</span></label>
                               <input type="file" name="drw_video"  value="<?=$draws->drw_video;?>" class="form-control" />
                               <span id="drw_video"></span>
                            </div>
