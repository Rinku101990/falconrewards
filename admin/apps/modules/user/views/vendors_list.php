                              ...
                              <table id="example" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="example_info">
                                 ...
                                 <tbody>
                                    ...
                                    <tr role="row" >
                                       ...
                                       <td><?php if($vdrlist->vnd_phone!=0){echo $vdrlist->vnd_phone;}else{ echo "NA";}?></td>
                                       <td>
                                       ...
                                       <td align="center"> 
                                          <a href="<?php echo site_url('user/seller/'.encode($vdrlist->vnd_id));?>" class="btn btn-info btn-sm mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="Profile"><i class="fa fa-user-circle-o"></i></a>
                                       </td>
                                    </tr>
                                    <?php } } ?>
                                 </tbody>
