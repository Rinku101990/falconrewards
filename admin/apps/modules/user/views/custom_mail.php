   ...
   <div class="section">
      ...
      <div class="page-header">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Manage Custom Mail</li>
         </ol>
      ...
      <div class="row">
         <div class="col-md-12 col-lg-12">
            <div class="card">
               <div class="card-header">
                  <div class="card-title">Custom Mail List</div>
        ...
        <input type="text"  name="subject" class="form-control " placeholder="Subject" /><br/>
                  <textarea rows="5" name="msg" class="form-control pd_description" id="summernote6" style="height: 100px; "></textarea><br/>
