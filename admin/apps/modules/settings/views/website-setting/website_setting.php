                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="Company_Details" class="form-horizontal" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea rows="3" class="form-control" name="web_address" placeholder="Enter Branch Address">
                                                            <?php echo $this->website->web_address; ?>
                                                        </textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea rows="3" class="form-control" name="web_addressmap" placeholder="Enter Google Map Link">
                                                            <?php echo $this->website->web_addressmap; ?>
                                                        </textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="web_timezone">
                                                            ...
                                                            ?>
                                                                <option value="<?php echo $ZID=$time_list->zone_id;?>" <?php if($this->website->web_timezone==$ZID)echo'selected'; ?>>
                                                                    <?=$time_list->zone_name;?>
                                                                </option>
                                                                <?php }}?>
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="web_pincode">
                                                            ...
                                                            ?>
                                                                <option value="<?php echo $ZID=$zc_list->zc_id;?>" <?php if($this->website->web_pincode==$ZID)echo'selected'; ?>>
                                                                    <?=$zc_list->zc_zipcode;?>
                                                                </option>
                                                                <?php }}?>
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea rows="2" class="form-control" name="web_copy_right" placeholder="Enter Footer Copy Right">
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal" method="post">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea rows="3" class="form-control" name="web_meta_title" placeholder="Enter Meta Title">
                                                            <?php echo $this->website->web_meta_title; ?>
                                                        </textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea rows="3" class="form-control" name="web_meta_keyword" placeholder="Enter Meta Keyword">
                                                            <?php echo $this->website->web_meta_keyword; ?>
                                                        </textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea rows="3" class="form-control" name="web_meta_description" placeholder="Enter Meta Description">
                                                            <?php echo $this->website->web_meta_description; ?>
                                                        </textarea>
                                                    </div>
                                                </div>
