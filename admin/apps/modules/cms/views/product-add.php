...
<div class="section">
   ...
   <div class="page-header">
      <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item active" aria-current="page">Add Coming Product</li>
      </ol>
      ...
      <div class="col-lg-10 col-xl-12 col-md-12 col-sm-12">
         <div class="card">
            <div class="card-header">
               <h3 class="card-title">Add Coming Product</h3>
            </div>
                  ...
                  <div class="row">
                     <div class="col-lg-12 col-md-12">
                        <div class="row">
                           ...
                           <div class="col-sm-6 col-md-10">
                              <div class="form-group">    
                                 <input type="text" class="form-control" name="name"  placeholder="English Product Name"  required="">                      
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-12 col-md-12" >
                        <div class="row">
                           ...
                           <div class="col-sm-6 col-md-8">
                              <div class="form-group">    
                                 <input type="file" class="form-control" name="img" id="image_file" onchange="preview_image();" required="" />  
                              </div>
                           </div>
                           <div class="col-sm-6 col-md-2">
                              <div class="form-group"> 
                     ...
                     <div class="col-lg-12 col-md-12">
                        <div class="row">
                           ...
                           <div class="col-sm-6 col-md-10">
                              <div class="form-group">    
                                 <textarea class="form-control" name="desc"  id="summernote2"  placeholder="Description"  style="height:100px"></textarea>                      
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-12 col-md-12">
                        <div class="row">
                           ...
                           <div class="col-sm-6 col-md-10">
                              <div class="form-group">    
                                 <input type="text" class="form-control" name="name_ar"  placeholder="Arabic Product Name"  required="">                      
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-12 col-md-12">
                        <div class="row">
                           ...
                           <div class="col-sm-6 col-md-10">
                              <div class="form-group">    
                                 <textarea class="form-control" name="desc_ar" id="summernote3" placeholder="Arabic Description"  style="height:100px"></textarea>                      
                              </div>
                           </div>
                        </div>
                     </div>
