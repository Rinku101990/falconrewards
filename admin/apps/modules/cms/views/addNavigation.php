      ...
      <div class="col-lg-10 col-xl-12 col-md-12 col-sm-12">
         <div class="card">
            <div class="card-header">
               <h3 class="card-title">Add Navigation</h3>
            </div>
                  ...
                  <div class="row">
                     <div class="col-lg-6 col-md-6">
                        <div class="row">
                           ...
                           <div class="col-sm-6 col-md-9">
                              <div class="form-group">    
                                 <input type="text" class="form-control" name="var_parent_name"  placeholder="Navigation name"  >                      
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-6 col-md-6">
                        <div class="row">
                           ...
                           <div class="col-sm-6 col-md-9">
                              <div class="form-group">    
                                 <input type="text" class="form-control" name="var_parent_name_ar"  placeholder="Navigation name arabic"  >                      
                              </div>
                           </div>
                        </div>
                     </div>
