   ...
   <div class="page-header">
      ...
      <div class="mt-3 mt-lg-0">
         <div class="d-flex align-items-center flex-wrap text-nowrap"> 
            ...
            <a href="<?=base_url('cms/navigations');?>">
                  ...
                  <div class="row">
                     <div class="col-lg-12 col-md-12">
                        <div class="row">
                           ...
                           <div class="col-sm-6 col-md-9">
                              <div class="form-group">    
                                 <input type="text" class="form-control" name="var_parent_name" value="<?=$navi->var_parent_name;?>"  placeholder="English Name"  >                      
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-12 col-md-12">
                        <div class="row">
                           ...
                           <div class="col-sm-6 col-md-9">
                              <div class="form-group">    
                                 <input type="text" class="form-control" name="var_parent_name_ar" value="<?=$navi->var_parent_name_ar;?>"  placeholder="Arabic Name"  >                      
                              </div>
                           </div>
                        </div>
                     </div>
