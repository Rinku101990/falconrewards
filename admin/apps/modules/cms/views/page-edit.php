      ...
      <div class="col-lg-10 col-xl-12 col-md-12 col-sm-12">
         <div class="card">
            <div class="card-header">
               <h3 class="card-title">Edit Content Page Detail</h3>
            </div>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-12 col-md-12">
                        <div class="row">
                           ...
                           <div class="col-sm-6 col-md-2">
                              <div class="form-group"> 
                                 <span id="image_preview"> <?php if(!empty($page->pg_banner_img)){?><img src="<?=base_url('uploads/content-page/').$page->pg_banner_img;?>"  style="width:150px; height: 40px; border:1px solid gray" /><?php }?></span>                    
                              </div>
                           </div>
                        </div>
                     </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                       <div class="row">
                          ...
                          <div class="col-sm-6 col-md-10">
                             <div class="form-group">    
                                <textarea class="form-control" name="content1" id="summernote2" placeholder="Template Subject"><?=$page->content1;?></textarea>
                             </div>
                          </div>
                       </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="row">
                           <div class="col-sm-6 col-md-2">
                              <div class="form-group">
                                 <label class="form-label">Title(Arabic) <span class="text-red">*</span></label>
                              </div>
                           </div>
                           <div class="col-sm-6 col-md-10">
                              <div class="form-group">    
                                 <input type="text" class="form-control" name="pg_title_ar" value="<?=$page->pg_title_ar;?>"  placeholder="Arabic Page Title"  >                      
                              </div>
                           </div>
                        </div>
                     </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-10">
                                <div class="form-group">    
                                    <textarea class="form-control" name="content2" id="summernote3" placeholder="Template Subject"><?=$page->content2;?></textarea>
                                </div>
                            </div> 
                        </div>
                    </div>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-10">
                            <button type="submit" class="btn btn-primary btn2" value="edit"><i class="fa fa-save"></i> Update Page</button>
