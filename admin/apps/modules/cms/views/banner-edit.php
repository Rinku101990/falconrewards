  ...
  <?php } ?>
    ...
    <input type="text" class="form-control" name="slr_name" value="<?=$banner->slr_name;?>" placeholder="Banner Name"  >                      
              ...
              <div class="col-lg-12 col-md-12">
                    ...
                    <div class="col-sm-6 col-md-2">
                        <div class="form-group">
                            <label class="form-label">Banner Name(Arabic) <span class="text-red">*</span></label>
                           </div>
                    </div>
          <div class="col-sm-6 col-md-8">
                        <div class="form-group">    
    <input type="text" class="form-control" name="slr_name_ar" value="<?=$banner->slr_name_ar;?>" placeholder="Banner Name Arabic"  >                      
                    </div>
                    </div> 
