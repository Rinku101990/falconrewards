   ...
   <div class="section">
      ...
      <div class="page-header">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Manage Coming Soon Products
            </li>
         </ol>
         <div class="mt-3 mt-lg-0">
            <div class="d-flex align-items-center flex-wrap text-nowrap"> 
               <button type="button" onclick="history.go(-1)" class="btn btn-secondary btn-icon-text mr-2 mb-2 mb-md-0"> <i class="fa fa-arrow-left"></i> Go Back  </button>
               <a href="<?=base_url('cms/product-add');?>">
         ...
         <div class="col-md-12 col-lg-12">
            <div class="card">
               <div class="card-header">
                  <div class="card-title">List Coming Soon Products</div>
                              ...
                              <table id="example" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="example_info">
                                 ...
                                 <tbody>
                                    ...
                                    <tr role="row" >
                                       ...
                                       <td> <img src="<?=base_url('uploads/coming-soon-product/').$list->img;?>"  style="width:100px; height: 50px;" /></td>
                                       <td> <?=$list->name;?></td>
                                       <td align="center">
                                          <a href="javascript:void(0);"onclick="javascript:showMyModalSetTitle('Change Status','product_status/',<?=$list->id;?>,<?php if($list->status=='1'){echo'2';}else{echo'1';}?>)">
                                          <span class="badge badge-<?php if($list->status=='1'){echo'success';}else{echo'danger';}?>-light badge-md"><i class="fa fa-<?php if($list->status=='1'){echo'check';}else{echo'ban';}?>"></i> <?php if($list->status=='1'){echo'Active';}else{echo'In-Active';}?></span></a>
                                       </td>
                                       <td align="center"> 
                                          <a href="<?=base_url('cms/product-edit/').encode($list->id);?>" class="btn btn-info btn-sm mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit"></i></a>
                                          <a href="javascript:void(0);" onclick="javascript:showMyModalSetTitle('Delete','product_delete/',<?=$list->id;?>,'')" class="btn btn-danger btn-sm mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="Delete"><i class="fa fa-trash"></i></a>
                                       </td>
                                    </tr>
                                    <?php }}?>
                                 </tbody>
