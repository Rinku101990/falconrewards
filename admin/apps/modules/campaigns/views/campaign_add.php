         ...
         <div class="card">
            ...
            <div class="card-body">
               <div class="account_login_form">
                  ...
                  <form id="CampaignForm" action="<?=base_url('campaigns/campaign_save');?>" method="post"  enctype="multipart/form-data">
                      ...
                      <?php $msg=$this->session->flashdata('msg'); if($msg){  ?>
                        ...
                        <div class="col-sm-6 col-md-6">
                           <label>Title <span class="red">*</span></label>
                           <input type="text" name="title_ar" class="form-control" placeholder="Enter Arabic Campaign Title">
                        </div>
                       
                        <div class="col-sm-6 col-md-6">
                           <label>URL <span class="red">*</span></label>
                           <input type="text" name="url"  class="form-control " placeholder="Enter Campaign URL Text">
                        </div>
                        <div class="col-sm-6 col-md-6">
                           <label>URL <span class="red">*</span></label>
                           <input type="text" name="url_ar"  class="form-control" placeholder="Enter Arabic Campaign URL Text">
                        </div>
