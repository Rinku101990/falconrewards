                ...
                <div class="card-header">
                  ...
                  <div class="table-responsive product-datatable">
                     <div id="example_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="row">
                           <div class="col-sm-12">
                                <?php //print("<pre>".print_r($ticketsbycategory,true)."</pre>");?>
                                <table id="example" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="example_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="w-15p sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Product name: activate to sort column descending" >Price</th>
                                    ...
                                    <tbody>
                                        <?php if(!empty($ticketsbycategory)){  $i=1;  foreach($ticketsbycategory AS $tktlist){?>
                                        <tr role="row" >
                                             <td class="sorting_1" align="center"><?=$i;$i++;?>.</td>
                                            <td class="sorting_1" align="center"><?=$tktlist->ord_reference_no;?></td>
                                            <td > <?=$tktlist->usr_fname.' '.$tktlist->usr_lname;?></td>
                                            <td> <?php echo $tktlist->ticket_no;?></td>
                                            <td > <?=$tktlist->price;?></td>
                                            <?php if($tktlist->created!='0000-00-00 00:00:00'){ ?>
