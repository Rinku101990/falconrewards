                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                    ...
                    <td class="text-uppercase" style="border: 1px solid #d5d2d2;padding: 5px;text-align: left;">AED<?php echo number_format($cmpt_ord_detail->tax,2);?></td>
									...
									<tr>
									  ...
									  <td style="border: 1px solid #d5d2d2;padding: 5px;text-align: left;"><?php echo date_format(date_create($cmpt_ord_detail->ord_created_date),'d-F-Y');?> <?php // echo date_format(date_create($cmpt_ord_detail->ord_created_date),'d-F-Y , h:i A');?></td>
                                    </tr>
