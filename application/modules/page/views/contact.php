      ...
      <div class="row">
         ...
         <div class="col-sm-6">
            <div class="padleft45">
               ...
               <?php if(!empty($this->variables[32]->var_parent_name)){?>
               <div class="contact_blocks contact_address">
                  <h3>Address</h3>
                  <p><?php echo $this->variables[32]->var_parent_name;?></p>
               </div>
               <?php }else{ ?>
               <div class="contact_blocks contact_address">
                  <h3>Address</h3>
         ...
         <div class="col-sm-6 pull-right">
            <div class="padleft45">
               ...
               <?php if(!empty($this->variables[32]->var_parent_name_ar)){?>
               <div class="contact_blocks contact_address">
                  <h3>عنوان</h3>
                  <p><?php echo $this->variables[32]->var_parent_name_ar;?></p>
               </div>
               <?php }else{ ?>
               <div class="contact_blocks contact_address">
                  <h3>عنوان</h3>
