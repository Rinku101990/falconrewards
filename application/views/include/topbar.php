               ...
               <div class="col-md-9">
                  ...
                  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                     <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="<?php echo site_url('winners');?>"><?php echo $this->variables[20]->var_parent_name;?></a>
                        </li>
                        <li><a href="<?php echo site_url('contact-us');?>"><?php echo $this->variables[21]->var_parent_name;?></a>
                        </li>
                        <li>
                  ...
                  <div class="user-detail-log-cart-section user-detail-log-cart-section-en" style="margin-top: 13px;    margin-left: 110px;">
                     <ul>
                           ...
                           <div class="profile-drop-down" style="margin-top: 0px !important;">
                              <div class="profile-dropdown">
                                 ...
                                 <div class="dropdown-content">
                                    <a href="<?php echo site_url('account/dashboard');?>"><?php echo $this->variables[36]->var_parent_name;?></a>
                                    <a href="<?php echo site_url('account/profile');?>"><?php echo $this->variables[37]->var_parent_name;?></a>
                                    <a href="<?php echo site_url('account/payment');?>"><?php echo $this->variables[38]->var_parent_name;?></a>
                                    <a href="<?php echo site_url('account/active_tickets');?>"><?php echo $this->variables[24]->var_parent_name;?></a>
                                    <a href="<?php echo site_url('account/change_password');?>"><?php echo $this->variables[39]->var_parent_name;?></a>
                                    <a href="<?php echo site_url('account/logout');?>"><?php echo $this->variables[40]->var_parent_name;?></a>
                                 </div>
                              </div>
                           </div>
                        </li>
                        ...
                        <li><a href="<?=base_url('login');?>" class=" login-btn" >
                           <i class="fa fa-user"></i> <?php echo $this->variables[7]->var_parent_name;?> </a>
                        </li>
                        <?php } ?>
