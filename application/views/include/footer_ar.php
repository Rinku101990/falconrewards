   ...
   <div class="container-fuild">
      <div class="row">
         <div class="col-sm-3 col-md-3 footer-top-spacing">
            ...
            <br>
            <h5 class="head_tag_5" style="margin-top: 55px;"><?php echo $this->variables[31]->var_parent_name_ar;?></h5>
         ...
         <div class="col-sm-3 col-md-3 col-lg-2 footer-top-spacing">
            <h5 class="head_tag_5"><?php echo $this->variables[22]->var_parent_name_ar;?></h5>
            <ul class="footer-links">
               <li><a href="<?php echo site_url('about-us');?>"><?php echo $this->variables[18]->var_parent_name_ar;?></a>
               </li>
               <li><a href="<?php echo site_url('');?>#Campaigns"><?php echo $this->variables[23]->var_parent_name_ar;?></a>
               </li>
               <?php if(!empty($this->session->userdata('logged_in_users'))){ ?>
                    <li class="active-ticket"><a href="<?php echo site_url('');?>account/active_tickets"><?php echo $this->variables[24]->var_parent_name_ar;?></a></li>
               <?php }else{?>
                    <li><a href="<?=base_url('login');?>"><?php echo $this->variables[24]->var_parent_name_ar;?></a></li>
               <?php }?>
         ...
         <div class="col-sm-3 col-md-3 col-lg-2 footer-top-spacing Customer-Service">
            <h5 class="head_tag_5"><?php echo $this->variables[26]->var_parent_name_ar;?></h5>
            <ul class="footer-links">
              <!--  <li><a href="<?php echo site_url('contact-us');?>">Contact Us</a>
               </li> -->
               <li><a href="<?php echo site_url('faq');?>"><?php echo $this->variables[27]->var_parent_name_ar;?></a>
               </li>
              ...
              <!--  <li><a href="<?php echo site_url('winners');?>">Winners</a>
               ...
               <li><a href="<?php echo site_url('charities');?>"><?php echo $this->variables[28]->var_parent_name_ar;?></a>
               </li>
                <li><a href="<?php echo site_url('privacy-policy');?>"><?php echo $this->variables[29]->var_parent_name_ar;?></a>
               </li>
                <li><a href="<?php echo site_url('terms-conditions');?>"><?php echo $this->variables[30]->var_parent_name_ar;?></a>
               </li>
            </ul>
         </div>
         <div class="col-md-4 col-lg-4 footer-top-spacing Contact-Us">
            <div class="footer-contacts">
               <h5 class="head_tag_5"><?php echo $this->variables[21]->var_parent_name_ar;?></h5>
               <a class="open-font" href="javascript:void(0)">
                  <span class="footer_add"><i class="fa fa-map-marker" aria-hidden="true"></i></span>
                  <?php echo $this->variables[32]->var_parent_name_ar;?>
               </a>
...
<footer id="footer" style="border: none;width: 95%;padding: 0 40px;">
 ...
 <div class="bottom" style="border: none; background: none;">
      <div class="container-fuild">
        <div class="row">
          <div class="col-lg-6">
            <?php if(!empty($this->variables[33]->var_parent_name_ar)){?>
            <p><?php echo $this->variables[33]->var_parent_name_ar; ?></p>
            <?php }else{ ?>
            <p><?php echo $this->website->web_copy_right; ?></p>
            <?php } ?>
       </div>
       <div class="col-lg-6 ">
            <?php if(!empty($this->variables[34]->var_parent_name_ar)){?>
            <p class="pull-right"><?php echo $this->variables[34]->var_parent_name_ar; ?></p>
            <?php }else{ ?>
